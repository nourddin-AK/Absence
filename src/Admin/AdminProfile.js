            ...
            <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
                  ...
                  <div className="flex my-2 w-full">
                     ...
                     <input 
                        ...
                        className={`rounded-r-md px-3 border bg-gray-50 text-grey-700 border-l-0 py-2  disabled:cursor-not-allowed outline-none ${style.input} ${errors.matricule ? style.errorBorder : style.border} ${style.focusInput}`} 
                  ...
                  <div className="flex my-2 w-full">
                     ...
                     <input 
                        ...
                        className={`rounded-r-md px-3 border bg-gray-50 text-grey-700 border-l-0 py-2   outline-none ${style.input} ${errors.name ? style.errorBorder : style.border} ${style.focusInput} `} 
                  ...
                  <div className="flex my-2 w-full">
                     ...
                     <input 
                        ...
                        className={`rounded-r-md px-3 border bg-gray-50 text-grey-700 border-l-0 py-2 outline-none ${style.input} ${errors.age ? style.errorBorder : style.border}  ${style.focusInput}`} 
                  ...
                  <label  className={`px-3 py-2  rounded-l-md border ${style.label}  ${errors.gender ? style.errorBorder : style.border} basis-1/2 max-w-[152px] `}>Gender </label>
                  <div className={`flex gap-4 bg-gray-50 text-grey-700 border ${style.input}  ${errors.gender ? style.errorBorder : style.border} rounded-r-md px-3 border border-l-0 py-2  flex-1`}>
