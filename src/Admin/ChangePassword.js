...
export default function ChangePassword ({user}) {
   //  const [selectedItem,setSelectedItem] = useState(user)
    ...
    return (
       ...
       {user.role === 'admin' && <button type="button" onClick={()=>setActiveModal('admin')} className="px-3 py-2 duration-300  text-gray-700 hover:underline  dark:text-gray-50" >Reset it</button>}
